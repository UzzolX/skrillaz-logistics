...
<head>
    ...
    <!--Title-->
    <title>Our Solutions e-commerce</title>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="banner-img" data-aos="zoom-in" data-aos-duration="2000">
                                <img src="{{asset('frontend-asstets/assets/image/banner/2.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="ecommerce" data-aos="zoom-in" data-aos-duration="2000">
                            <h2>
                                Own the customer experience and offer same day delivery straight from your online check-out page.
                            </h2>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="mobile" data-aos="zoom-in" data-aos-duration="2000">
                            <img src="{{asset('frontend-asstets/assets/image/banner/mobile.svg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
