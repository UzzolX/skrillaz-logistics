...
<head>
    ...
    <!--Title-->
    <title>Our Solutions Courier</title>
...
<body>
    ...
    <main class="main-area">
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="banner-img" data-aos="zoom-in" data-aos-duration="2000">
                                <img src="{{asset('frontend-asstets/assets/image/banner/4.svg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="mobile" data-aos="zoom-in" data-aos-duration="2000">
                            <img src="{{asset('frontend-asstets/assets/image/banner/mobilebike.svg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--white area start-->
        <section class="orange-area pt-100 pb-100">
            <div class="container ">
                <div class="col-xl-12">
